...
module.exports = {
    ...
    getPosts: (req, res) => {
        Post.find()
            .populate('category')
            .then(posts => {
                res.render('users/posts/index', {posts: posts});
            });
    },
    ...
    getCreatePostPage: (req, res) => {
        Category.find().then(cats => {
            ...
            res.render('users/posts/create', {categories: cats});
        });
    ...
    getEditPostPage: (req, res) => {
        ...
        Post.findById(id)
            .then(post => {
                Category.find().then(cats => {
                    res.render('user/posts/edit', {post: post, categories: cats});
                });
            });
    },
    ...
    getCategories: (req, res) => {
        ...
        Category.find().then(cats => {
            res.render('user/category/index', {categories: cats});
        });
    },
    ...
    getEditCategoriesPage: async (req, res) => {
        ...
        Category.findById(catId).then(cat => {
            ...
            res.render('user/category/edit', {category: cat, categories: cats});
